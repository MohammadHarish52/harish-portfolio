  ...
  return (
    <div className="py-[180px] sm:py-[290px] w-full ">
      <div className="flex  flex-col justify-between items-start sm:flex-row gap-[10px] flex-wrap">
        <h1 className="text-[18px] font-[500] tracking[.-5px] ">(Work)</h1>
        <div className="flex flex-col ">
          <p className="text-[31px] findme  sm:text-[40px] font-[500] text-left sm:leading-[48px] leading-[39px] pb-[80px] sm:tracking-[-1.3px] tracking-[-.8px]">
